 ...
 * @author master
 */
public class AuthorFilterCommand implements Command {

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("AuthorFilterCommand");
        String idGenre = request.getParameter("idAuthor");
        ...
        List<String> list = client.authorFilter(Integer.valueOf(idGenre)).getString();
