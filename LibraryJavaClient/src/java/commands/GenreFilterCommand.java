 ...
 * @author master
 */
public class GenreFilterCommand implements Command {

    @Override
    public void execute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        System.out.println("GenreFilterCommand");
        ...
        List<String> list = client.genreFilter(Integer.valueOf(idGenre)).getString();
