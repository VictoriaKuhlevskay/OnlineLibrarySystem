            ...
            <div id="middle"> 
                <div id="reg">
                    <form action="/LibraryJavaClient/Servlet" method="POST">
                        ...
                        <input type="submit" name="ok" value="Зарегистрироваться" onclick="w3()"></form>
                </div>
                <div id="welcome">
                    <h1>
                    ...
                    <p>
                        Здесь Вы сможете не только найти интересующую Вас книгу, но и скачать её совершенно бесплатно!
                    </p>
                    <p><img src=images/internet.jpg></p>
                </div>
            </div>
            <div id="bottom">
                <p>Минск, 2016</p>
